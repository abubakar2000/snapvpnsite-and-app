                  ...
                  <form method="POST" action="includes/routes.php">
                    <div class="row">					  
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="bmd-label-floating">Rewarded ID</label>
                                <input type="text"  value="<?php echo $RewardedAdID; ?>"name="RewardedAdID" class="form-control">
                            </div>
                        </div>
                    ...
                    <button type="submit" name="<?php if($is_edit){echo "editAds";}else{echo "addAds";}?>" class="btn btn-primary pull-right"><?php if($is_edit){echo "Update";}else{echo "Add";}?></button>
